...
PHONE_PATTERNS = [
    ...
    r'[78]9\d{9}',                                                 # 89991234567 или 79991234567 (мобильные)
    r'(?<!\d)9\d{9}(?!\d)',                                        # 9991234567 (мобильный без кода страны)
    r'\+\d{10,15}',                                                # международные с +
]
...
PROFANITY_ROOTS = {
    # === ОСНОВНОЙ МАТ ===
    # Х-слово и производные
    'хуй', 'хуя', 'хуе', 'хуи', 'хую', 'хуём', 'хуёв', 'хуев', 'хуйн', 'хуйл',
    'хуяр', 'хуяч', 'хуяк', 'хуёж', 'охуе', 'охуи', 'охуён', 'нахуй', 'нахуя',
    'похуй', 'похуя', 'дохуя', 'нихуя', 'отхуяч', 'захуяр', 'выхуяр', 'прихуяр',

    # П-слово и производные
    'пизд', 'пезд', 'пиздец', 'пиздат', 'пиздюк', 'пиздюл', 'пизду', 'пизды',
    'пиздан', 'пиздобол', 'пиздострадал', 'распизд', 'опизд', 'запизд', 'напизд',
    'спизд', 'выпизд', 'отпизд', 'пропизд', 'упизд',

    # Б-слово и производные (ВАЖНО: добавлено "бля")
    'бля', 'блять', 'блядь', 'блят', 'бляд', 'блядин', 'блядск', 'блядов',
    'блядун', 'блядищ', 'блядств', 'заблядов', 'выблядок', 'приблядов',
    'бляха', 'бляхомуха',

    # Е-слово и производные (убраны короткие 'еб', 'ёб' — дают ложные срабатывания на "мебель")
    'ебат', 'ебан', 'ебну', 'ебёт', 'ебет', 'ебал', 'ебла', 'ебли', 'ебло',
    'ебуч', 'ебись', 'ебёш', 'ебеш', 'ебик', 'ебарь', 'ебака',
    'ебук', 'ёбан', 'ебанн', 'ебанут', 'ебашит', 'ебаш', 'ебош', 'ебень',
    'въеба', 'выеба', 'доеба', 'заеба', 'изъеба', 'наеба', 'объеба', 'отъеба', 'подъеба',
    'поеба', 'приеба', 'проеба', 'разъеба', 'съеба', 'уеба', 'долбоёб', 'долбаёб',
    'долбоеб', 'ёбтвою', 'ебтвою', 'ебена', 'ёбаный', 'ебаный', 'ёбаная', 'ебаная',

    # === ГРУБЫЕ ОСКОРБЛЕНИЯ ===
    'сука', 'суки', 'сучк', 'сучар', 'сучий', 'сучон', 'сученыш', 'сучён',
    'мудак', 'мудил', 'мудо', 'мудозвон', 'мудохат', 'мудищ', 'мудень',
    'залуп', 'залупа', 'залупин',
    'гандон', 'гондон', 'гондур',
    'педик', 'педер', 'пидор', 'пидар', 'пидр', 'пидорас', 'пидарас',
    'пидрил', 'педрил', 'пидораст',
    'шлюх', 'шлюш', 'шалав',
    'курв', 'курва',
    'потаскух', 'потаскуш',
    'даун', 'дебил', 'дебилоид', 'имбецил', 'олигофрен',
    'уебан', 'уёбан', 'уебок', 'уёбок', 'уебищ', 'уёбищ',
    'выблядок', 'ублюд', 'ублюдок', 'ублюдк',
    'мразь', 'мразот', 'падл', 'падаль',
    'тварь', 'тварин',
    'чмо', 'чмошн', 'чмыр',
    'лох', 'лошар', 'лошок', 'лохан',
    'чурк', 'чурбан', 'черножоп', 'чернож',

    # === ТЕЛЕСНЫЕ ===
    'жопа', 'жоп', 'жопн', 'жопк', 'жопош', 'жопорук', 'жопол', 'зажоп',
    'сраный', 'сран', 'срань', 'срат', 'срал', 'насрат', 'насрал', 'обосрал',
    'высрал', 'засран', 'просрал', 'усрал', 'осрал', 'подсрач', 'срака',
    'говно', 'говён', 'говн', 'говнюк', 'говняш', 'говнист', 'говняк', 'говнар',
    'дерьмо', 'дерьм', 'дерьмов',
    'засер', 'засир', 'высер', 'высир', 'насер', 'насир', 'обсер', 'обсир',
    'пердеж', 'пердёж', 'пердел', 'пёрдел', 'пердун', 'пердюк',
    'сикел', 'ссык', 'ссыкл', 'ссыкун', 'зассал', 'обоссал', 'поссал',

    # === АНГЛИЙСКИЙ МАТ ===
    'fuck', 'fucking', 'fucker', 'fucked', 'motherfuck',
    'shit', 'shitty', 'bullshit', 'shitter',
    'bitch', 'bitchy', 'bitches',
    'asshole', 'arsehole', 'ass ', ' ass', 'arse',
    'dick', 'dickhead', 'dickface',
    'cock', 'cocksucker',
    'pussy', 'cunt', 'twat',
    'whore', 'slut', 'skank',
    'bastard', 'wanker', 'tosser', 'prick',
    'nigger', 'nigga', 'negro',
    'fag', 'faggot',
    'retard', 'retarded',

    # === ЭВФЕМИЗМЫ И ЗАМЕНЫ БУКВ ===
    'xyй', 'xуй', 'ху й', 'х у й', 'хyй', 'х*й', 'ху*', '*уй',
    'п1зд', 'п и з д', 'пи3д', 'п*зд', 'пи|зд',
    'б л я', 'бл*', 'б*я', 'б**ть', 'бляя', 'блеать',
    'еб*', '*бать', 'е*ать', 'ё*ать', 'йоб', 'ёпт', 'епт', 'йобан',
    'п0рн', 'пopн', 'п*рн',
    'с*ка', 'су*а', 'с у к а',
    'г*вно', 'г0вно', 'г о в н о',
}
...
PORN_WORDS = {
    ...
    'эскорт', 'эскортниц',
    'минет', 'миньет',
    'анальн', 'анальщ',  # Убрано короткое 'анал' — дает ложные срабатывания на "канал"
    'оргия', 'оргии',
    'групповух',
    'бдсм', 'bdsm',
    'фетиш',
...
async def validate_content_with_llm(
    ...
    # Шаг 1: Быстрая rule-based проверка (с учётом типа контента)
    if content_type == "link_url":
        # Для URL ссылки пропускаем rule-based (там и так URL), только LLM проверит контент
        pass
    elif content_type == "link_title":
        ...
        # Для остального контента — полная проверка
